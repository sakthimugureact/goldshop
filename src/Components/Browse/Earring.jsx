...
function Earring() {
    ...
    useEffect(()=>{
        fetch('/design.json').then(res=>res.json()).then(data=>setIE(data.innerearrings))
    },[])
      ...
      <div className="container-fluid">
        <div className="row pb-5">
          ...
          <div className="col-12 col-md-9 mx-auto">
            ...
            <h3 className="fw-bold fs-3 pt-5">Earrings</h3>
            <div className="d-flex justify-content-between mt-5">
              <h3 className="fw-bold fs-3">Stone Jhumkas</h3>
             <Link to={'/earringmore'}><button className="expbtn">Explore More</button></Link>
            </div>
            <div className="container mt-4 pb-5">
                ...
                <div className="scroll-container overflow-scroll bg-light p-3">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <h6 className="mb-0 py-3">Full Pearl Jhumkas</h6>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ backgroundColor: "#4a1c03", color: "white" }}
                      >
                        <h6 className="mb-0 py-3">Pearl Jhumka</h6>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ backgroundColor: "#4a1c03", color: "white" }}
                      >
                        <h6 className="mb-0 py-3">Ring Jhumka</h6>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ backgroundColor: "#4a1c03", color: "white" }}
                      >
                        <h6 className="mb-0 py-3">Maroon Stone Jhumka</h6>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ backgroundColor: "#4a1c03", color: "white" }}
                      >
                        <h6 className="mb-0 py-3">Green & Pink Jhumka </h6>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ backgroundColor: "#4a1c03", color: "white" }}
                      >
                        <h6 className="mb-0 py-3">Oxidized Jhumka</h6>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <h3 className="fw-bold fs-3">Exclusive Fusion Designing</h3>
              <Link to={'/earringmore'}><button className="expbtn">Explore More</button></Link>
            </div>
            <div className="container mt-4 pb-5">
              <div className="container">
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ backgroundColor: "#4a1c03", color: "white" }}
                      >
                        <h6 className="mb-0 py-3">Gold Plated Earring</h6>
                      </div>
                    </div>
                  </div>
                </div>
