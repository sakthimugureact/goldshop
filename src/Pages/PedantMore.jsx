...
function PedantMore() {
    ...
    useEffect(()=>{
        fetch('/design.json').then(res=>res.json()).then(data=>setMore(data.pedants))
    },[])
  ...
  return (
    ...
    <div className="row gap-3 mx-auto mb-5">
        <Link to="/pedant" className='ps-5 py-3 fs-2 fw-bold text-dark'><ArrowLeft/></Link>
